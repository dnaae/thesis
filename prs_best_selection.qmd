...
for (threshold in p_value_columns) {
  ...
  for (fold in 1:k_folds) {
    ...
    # Predict and calculate residuals for the test set
...
```{r}
#After selecting the best threshold print regression statistics
...
# Calculate the mean and standard deviation on the full dataset (merged_data)
